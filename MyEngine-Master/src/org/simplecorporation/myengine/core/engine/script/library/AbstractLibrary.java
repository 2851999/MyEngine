...
public abstract class AbstractLibrary extends Library {
	...
	public abstract void parseCode(ScriptFile currentFile , String currentLine , LinkedList<ScriptVariable> publicVariables , LinkedList<ScriptVariable> localVariables);
