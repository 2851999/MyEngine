...
public class BitmapFont {
	...
	public void render(String text , double x , double y) {
		...
		for (int a = 0; a < text.length(); a++) {
			...
			BasicRenderer.renderImage(this.image , x , y - (this.fontSize / 1.25) , (this.cellWidth / this.cellHeight) * this.fontSize , this.fontSize , cellX , cellY , cellWidth , cellHeight);
