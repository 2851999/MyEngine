...
public class GUIRenderableDropDownMenu extends GUIDropDownMenu {
	
	/* The background colour */
	public Colour backgroundColour;
	
	/* The constructor */
	public GUIRenderableDropDownMenu(String name , GUIButton menuButton , Colour backgroundColour) {
