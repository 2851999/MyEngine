...
public class BasicRenderer2DJava {
	...
	public static void setColour(Colour colour) {
		...
		RenderVariablesJava.g2d.setColor(new Color((float)colour.r , (float)colour.g , (float)colour.b , (float)colour.a));
	}
	...
	public static void renderRectangle(double x , double y , double width , double height) {
		...
		RenderVariablesJava.g2d.drawRect((int) x , (int) y , (int) width , (int) height);
	}
	...
	public static void renderFilledRectangle(double x , double y , double width , double height) {
		//Render the rectangle
		RenderVariablesJava.g2d.fillRect((int) x , (int) y , (int) width , (int) height);
	}
	
	/* The method to render a line */
	public static void renderLine(double startx , double starty , double endx , double endy) {
		//Render the line
		RenderVariablesJava.g2d.drawLine((int) startx , (int) starty , (int) endx , (int) endy);
	}
	
	/* The method to render an image */
	public static void renderImage(Image image , double x , double y) {
		//Render the image
		RenderVariablesJava.g2d.drawImage(image.getJavaImage() , (int) x , (int) y , JavaWindow.frame);
	}
	...
	public static void renderImage(Image image , double x , double y , double rotation) {
		...
		//Render the image
		RenderVariablesJava.g2d.drawImage(image.getJavaImage() , at , RenderVariablesJava.container);
	}
	...
	public static void renderImage(Image image , double x , double y , double width , double height) {
		//Render the image
		RenderVariablesJava.g2d.drawImage(image.getJavaImage() , (int) x , (int) y , (int) width , (int) height , RenderVariablesJava.container);
	}
	...
	public static void renderImage(Image image , double x , double y , double width , double height , double imageX , double imageY ,
		...
		//Render the image
		RenderVariablesJava.g2d.drawImage(image.getJavaImage() , (int) x , (int) y , (int) x + (int) width , (int) y + (int) height , (int) imageX , (int) imageY ,
				(int) imageX + (int) imageWidth , (int) imageY + (int) imageHeight , RenderVariablesJava.container);
	}
