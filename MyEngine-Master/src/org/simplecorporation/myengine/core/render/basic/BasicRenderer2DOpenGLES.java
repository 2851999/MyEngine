...
public class BasicRenderer2DOpenGLES {
	...
	public static void renderRectangle(double x , double y , double width , double height) {
		...
		//Render the shape
		OpenGLESRendererUtils.render(vertices, order, BasicRenderer.currentColour, 2, GL10.GL_LINES);
	}
	...
	public static void renderFilledRectangle(double x , double y , double width , double height) {
		...
		//Render the shape
		OpenGLESRendererUtils.render(vertices, order, BasicRenderer.currentColour, 2, GL10.GL_TRIANGLE_FAN);
	}
	...
	public static void renderImage(Image image , double x , double y) {
		...
		//Render the shape
		OpenGLESRendererUtils.render(vertices, textures, order, BasicRenderer.currentColour, image, 2, GL10.GL_TRIANGLE_FAN);
	}
